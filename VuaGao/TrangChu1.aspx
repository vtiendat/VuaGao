<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrangChu1.aspx.cs" Inherits="VuaGao.TrangChu1" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <li><a href="DatHang.aspx" target="b">Đặt Hàng</a></li>   
        ...
        <li><asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">Thông Tin Tài Khoản</asp:LinkButton></li>
        <li>
            <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">Đăng Xuất</asp:LinkButton></li>
        </ul>
	</div>
   <%-- wallap --%>
        <div id="wallap">
